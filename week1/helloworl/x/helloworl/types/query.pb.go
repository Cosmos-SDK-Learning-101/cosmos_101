...
// source: helloworl/helloworl/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_4a8218c51875157e, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_4a8218c51875157e, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "helloworl.helloworl.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "helloworl.helloworl.QueryParamsResponse")
}

func init() { proto.RegisterFile("helloworl/helloworl/query.proto", fileDescriptor_4a8218c51875157e) }

var fileDescriptor_4a8218c51875157e = []byte{
	// 282 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xcf, 0x48, 0xcd, 0xc9,
	0xc9, 0x2f, 0xcf, 0x2f, 0xca, 0xd1, 0x47, 0xb0, 0x0a, 0x4b, 0x53, 0x8b, 0x2a, 0xf5, 0x0a, 0x8a,
	...
	0xff, 0xff, 0xc1, 0xcf, 0xcc, 0x70, 0xec, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/helloworl.helloworl.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworl.helloworl.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "helloworl.helloworl.Query",
	...
	Metadata: "helloworl/helloworl/query.proto",
}
