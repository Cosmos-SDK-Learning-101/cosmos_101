...
// source: lession1/lession1/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b802a2b35abc211b, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b802a2b35abc211b, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "lession1.lession1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "lession1.lession1.QueryParamsResponse")
}

func init() { proto.RegisterFile("lession1/lession1/query.proto", fileDescriptor_b802a2b35abc211b) }

var fileDescriptor_b802a2b35abc211b = []byte{
	// 279 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xcd, 0x49, 0x2d, 0x2e,
	0xce, 0xcc, 0xcf, 0x33, 0xd4, 0x87, 0x33, 0x0a, 0x4b, 0x53, 0x8b, 0x2a, 0xf5, 0x0a, 0x8a, 0xf2,
	...
	0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0xe1, 0x64, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x5d,
	0xa8, 0xb0, 0xd1, 0xdb, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lession1.lession1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lession1.lession1.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "lession1.lession1.Query",
	...
	Metadata: "lession1/lession1/query.proto",
}
